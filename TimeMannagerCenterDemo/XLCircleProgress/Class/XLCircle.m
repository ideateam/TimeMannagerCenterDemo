...
-(void)buildLayout
{
    ...
    backLayer.strokeColor  = [UIColor colorWithRed:251.0/255.0f green:209.0/255.0f blue:209.0/255.0f alpha:1].CGColor;
    ...
    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[RGB(251, 86, 88) CGColor],(id)[RGB(255, 86, 0) CGColor], nil]];
...
-(void)setProgress:(float)progress
{
    ...
    [self performSelectorOnMainThread:@selector(updateEndPoint) withObject:nil waitUntilDone:YES];
